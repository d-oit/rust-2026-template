...
| `architecture-diagram` | [skills/architecture-diagram/SKILL.md](skills/architecture-diagram/SKILL.md) | Generate an Excalidraw source file and rendered SVG diagram by scanning the live project structure,  |
