...
[![Template Version](https://img.shields.io/badge/version-0.3.7-blue)](.template/CHANGELOG-TEMPLATE.md#0.3.7)

**Latest release: v0.3.7** — see [`.template/CHANGELOG-TEMPLATE.md`](.template/CHANGELOG-TEMPLATE.md) for the full changelog.
