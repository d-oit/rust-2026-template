...
[![Template Version](https://img.shields.io/badge/version-0.3.8-blue)](.template/CHANGELOG-TEMPLATE.md#0.3.8)

**Latest release: v0.3.8** — see [`.template/CHANGELOG-TEMPLATE.md`](.template/CHANGELOG-TEMPLATE.md) for the full changelog.
